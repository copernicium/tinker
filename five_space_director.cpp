#include <stdlib.h> // A very simple program (my -- Logan's-- first) for receiving directions from your current location to another in an area consisting of five spaces.
#include<iostream>
using namespace std;
int main(){
        int y;
